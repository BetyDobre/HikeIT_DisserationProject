...
insert ignore into grupe_muntoase(id, titlu, pozaHarta) values (6, 'Buzaului', LOAD_FILE('C:\\Users\\Betty\\Desktop\\HikeIT_DisserationProject\\hike\\src\\main\\resources\\static\\img\\grupeMuntoase\\buzaului.jpg'));
insert ignore into grupe_muntoase(id, titlu, pozaHarta) values (7, 'Ceahlau', LOAD_FILE('C:\\Users\\Betty\\Desktop\\HikeIT_DisserationProject\\hike\\src\\main\\resources\\static\\img\\grupeMuntoase\\ceahlau1.jpg'));
insert ignore into grupe_muntoase(id, titlu, pozaHarta) values (8, 'Ciucas', LOAD_FILE('C:\\Users\\Betty\\Desktop\\HikeIT_DisserationProject\\hike\\src\\main\\resources\\static\\img\\grupeMuntoase\\ciucas2.jpg'));
